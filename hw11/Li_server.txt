...
int main(int argc, char *argv[]) {
	...
	if (send(clientSockfd, "Connected!!!\n", 
       ...
       // ##################################################
       // modified part start
	   if (numBytes  > 5){ // if the number of input bytes is lager than 5, ignore it, do nothing
	       printf("Please enter less than or equal to 5 charactors !\n");
            }else{ // else the number of input bytes is less than 5, will not perform buffer overflow
            recvBuff[numBytes] = '\0';    
            strcpy(str, recvBuff);
           }
        // modified part end
...
/*
yinuo@yinuo-VirtualBox:~/ECE404/hw11$ ./client2 localhost 9000
Connected!!!
Say something: sss
You Said: sss

Say something: sssssssssssssss
You Said: sss

Say something: ssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss
You Said: sss
...
Say something: sssssssssssssssss
You Said: s

Say something: 
#################################################################
yinuo@yinuo-VirtualBox:~/ECE404/hw11$ gcc -fno-stack-protector server2.c -o server2
yinuo@yinuo-VirtualBox:~/ECE404/hw11$ ./server2 9000
...
Please enter less than or equal to 5 charactors !
RECEIVED: sssssssssssssss
SENT: sss
RECEIVED BYTES: 16

Please enter less than or equal to 5 charactors !
RECEIVED: ssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss
SENT: sss
RECEIVED BYTES: 159
